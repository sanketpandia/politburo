...
\restrict ctURAgXLFAZF4Qthc58RRWfe5CaB6ggdUYbnky2DQw6V8Wvwc3ZcHKEs50dqUep
...
ALTER TABLE IF EXISTS ONLY public.va_user_roles DROP CONSTRAINT IF EXISTS va_user_roles_va_id_fkey;
ALTER TABLE IF EXISTS ONLY public.va_user_roles DROP CONSTRAINT IF EXISTS va_user_roles_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.va_configs DROP CONSTRAINT IF EXISTS va_configs_va_id_fkey;
ALTER TABLE IF EXISTS ONLY public.livery_airtable_mappings DROP CONSTRAINT IF EXISTS livery_airtable_mappings_va_id_fkey;
ALTER TABLE IF EXISTS ONLY public.events DROP CONSTRAINT IF EXISTS events_va_id_fkey;
ALTER TABLE IF EXISTS ONLY public.events DROP CONSTRAINT IF EXISTS events_updated_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.events DROP CONSTRAINT IF EXISTS events_created_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.event_legs DROP CONSTRAINT IF EXISTS event_legs_updated_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.event_legs DROP CONSTRAINT IF EXISTS event_legs_event_id_fkey;
ALTER TABLE IF EXISTS ONLY public.event_legs DROP CONSTRAINT IF EXISTS event_legs_created_by_id_fkey;
...
DROP INDEX IF EXISTS public.idx_va_user_roles_va_id;
DROP INDEX IF EXISTS public.idx_va_user_roles_user_va;
DROP INDEX IF EXISTS public.idx_va_user_roles_user_id;
DROP INDEX IF EXISTS public.idx_va_provider_validation_history_status;
DROP INDEX IF EXISTS public.idx_va_provider_validation_history_config_id;
DROP INDEX IF EXISTS public.idx_va_provider_configs_va_provider_type;
DROP INDEX IF EXISTS public.idx_va_provider_configs_provider;
DROP INDEX IF EXISTS public.idx_va_provider_configs_features;
DROP INDEX IF EXISTS public.idx_va_provider_configs_errors;
DROP INDEX IF EXISTS public.idx_va_provider_configs_data;
DROP INDEX IF EXISTS public.idx_va_provider_configs_config_type;
DROP INDEX IF EXISTS public.idx_va_provider_configs_active;
DROP INDEX IF EXISTS public.idx_va_discord_server_id;
DROP INDEX IF EXISTS public.idx_va_configs_va_key;
DROP INDEX IF EXISTS public.idx_va_configs_va_id;
DROP INDEX IF EXISTS public.idx_users_username;
DROP INDEX IF EXISTS public.idx_users_discord_id;
DROP INDEX IF EXISTS public.idx_route_at_synced_coordinates;
DROP INDEX IF EXISTS public.idx_pirep_at_synced_server_id;
DROP INDEX IF EXISTS public.idx_pirep_at_synced_route_at_id;
DROP INDEX IF EXISTS public.idx_pirep_at_synced_pilot_callsign;
DROP INDEX IF EXISTS public.idx_pirep_at_synced_pilot_at_id;
DROP INDEX IF EXISTS public.idx_pirep_at_synced_flight_mode;
DROP INDEX IF EXISTS public.idx_pirep_at_synced_at_created_time;
DROP INDEX IF EXISTS public.idx_livery_mappings_va_livery;
DROP INDEX IF EXISTS public.idx_livery_mappings_va_id;
DROP INDEX IF EXISTS public.idx_livery_mappings_lookup;
DROP INDEX IF EXISTS public.idx_events_va_id;
DROP INDEX IF EXISTS public.idx_events_updated_by;
DROP INDEX IF EXISTS public.idx_events_status;
DROP INDEX IF EXISTS public.idx_events_date_range;
DROP INDEX IF EXISTS public.idx_events_created_by;
DROP INDEX IF EXISTS public.idx_event_legs_updated_by;
DROP INDEX IF EXISTS public.idx_event_legs_route_at_id;
DROP INDEX IF EXISTS public.idx_event_legs_leg_number;
DROP INDEX IF EXISTS public.idx_event_legs_event_id;
DROP INDEX IF EXISTS public.idx_event_legs_created_by;
DROP INDEX IF EXISTS public.idx_airports_icao;
DROP INDEX IF EXISTS public.idx_airports_iata;
DROP INDEX IF EXISTS public.idx_airports_coordinates;
DROP INDEX IF EXISTS public.idx_aircraft_liveries_sync;
DROP INDEX IF EXISTS public.idx_aircraft_liveries_livery_id;
DROP INDEX IF EXISTS public.idx_aircraft_liveries_aircraft_id;
DROP INDEX IF EXISTS public.idx_aircraft_liveries_active_livery;
DROP INDEX IF EXISTS public.idx_aircraft_liveries_active;
ALTER TABLE IF EXISTS ONLY public.virtual_airlines DROP CONSTRAINT IF EXISTS virtual_airlines_pkey;
ALTER TABLE IF EXISTS ONLY public.virtual_airlines DROP CONSTRAINT IF EXISTS virtual_airlines_discord_server_id_key;
ALTER TABLE IF EXISTS ONLY public.virtual_airlines DROP CONSTRAINT IF EXISTS virtual_airlines_code_key;
ALTER TABLE IF EXISTS ONLY public.va_user_roles DROP CONSTRAINT IF EXISTS va_user_roles_pkey;
ALTER TABLE IF EXISTS ONLY public.va_sync_history DROP CONSTRAINT IF EXISTS va_sync_history_pkey;
ALTER TABLE IF EXISTS ONLY public.va_data_provider_configs DROP CONSTRAINT IF EXISTS va_data_provider_configs_pkey;
ALTER TABLE IF EXISTS ONLY public.va_configs DROP CONSTRAINT IF EXISTS va_configs_va_id_config_key_key;
ALTER TABLE IF EXISTS ONLY public.va_configs DROP CONSTRAINT IF EXISTS va_configs_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_discord_id_key;
ALTER TABLE IF EXISTS ONLY public.event_legs DROP CONSTRAINT IF EXISTS unique_route_per_event;
ALTER TABLE IF EXISTS ONLY public.event_legs DROP CONSTRAINT IF EXISTS unique_leg_per_event;
ALTER TABLE IF EXISTS ONLY public.route_at_synced DROP CONSTRAINT IF EXISTS route_at_synced_unique;
ALTER TABLE IF EXISTS ONLY public.route_at_synced DROP CONSTRAINT IF EXISTS route_at_synced_pkey;
ALTER TABLE IF EXISTS ONLY public.pirep_at_synced DROP CONSTRAINT IF EXISTS pirep_at_synced_unique;
ALTER TABLE IF EXISTS ONLY public.pirep_at_synced DROP CONSTRAINT IF EXISTS pirep_at_synced_pkey;
ALTER TABLE IF EXISTS ONLY public.pilot_at_synced DROP CONSTRAINT IF EXISTS pilot_at_synced_server_at_id_key;
ALTER TABLE IF EXISTS ONLY public.pilot_at_synced DROP CONSTRAINT IF EXISTS pilot_at_synced_pkey;
ALTER TABLE IF EXISTS ONLY public.livery_airtable_mappings DROP CONSTRAINT IF EXISTS livery_airtable_mappings_va_id_livery_id_field_type_key;
ALTER TABLE IF EXISTS ONLY public.livery_airtable_mappings DROP CONSTRAINT IF EXISTS livery_airtable_mappings_pkey;
ALTER TABLE IF EXISTS ONLY public.events DROP CONSTRAINT IF EXISTS events_pkey;
ALTER TABLE IF EXISTS ONLY public.event_legs DROP CONSTRAINT IF EXISTS event_legs_pkey;
ALTER TABLE IF EXISTS ONLY public.api_keys DROP CONSTRAINT IF EXISTS api_keys_pkey;
ALTER TABLE IF EXISTS ONLY public.airports DROP CONSTRAINT IF EXISTS airports_pkey;
ALTER TABLE IF EXISTS ONLY public.airports DROP CONSTRAINT IF EXISTS airports_icao_key;
ALTER TABLE IF EXISTS ONLY public.aircraft_liveries DROP CONSTRAINT IF EXISTS aircraft_liveries_pkey;
ALTER TABLE IF EXISTS ONLY public.aircraft_liveries DROP CONSTRAINT IF EXISTS aircraft_liveries_livery_id_key;
DROP TABLE IF EXISTS public.virtual_airlines;
DROP TABLE IF EXISTS public.va_user_roles;
DROP TABLE IF EXISTS public.va_sync_history;
DROP TABLE IF EXISTS public.va_provider_validation_history;
DROP TABLE IF EXISTS public.va_data_provider_configs;
DROP TABLE IF EXISTS public.va_configs;
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.route_at_synced;
DROP TABLE IF EXISTS public.pirep_at_synced;
DROP TABLE IF EXISTS public.pilot_at_synced;
DROP TABLE IF EXISTS public.livery_airtable_mappings;
DROP TABLE IF EXISTS public.events;
DROP TABLE IF EXISTS public.event_legs;
DROP TABLE IF EXISTS public.api_keys;
DROP TABLE IF EXISTS public.airports;
DROP TABLE IF EXISTS public.aircraft_liveries;
DROP FUNCTION IF EXISTS public.update_events_timestamp();
DROP FUNCTION IF EXISTS public.update_event_legs_timestamp();
DROP TYPE IF EXISTS public.validation_status;
DROP TYPE IF EXISTS public.va_role;
--
...
--
-- Name: update_event_legs_timestamp(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: event_legs; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.events (
    ...
    CONSTRAINT events_status_check CHECK (((status)::text = ANY ((ARRAY['draft'::character varying, 'active'::character varying, 'completed'::character varying, 'cancelled'::character varying])::text[])))
);
...
--
-- Name: event_legs event_legs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_legs unique_leg_per_event; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_legs unique_route_per_event; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_event_legs_created_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_legs_event_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_legs_leg_number; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_legs_route_at_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_legs_updated_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_events_updated_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_events_va_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_va_provider_configs_config_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_va_provider_configs_va_provider_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_va_provider_validation_history_config_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_va_provider_validation_history_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: event_legs trigger_event_legs_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: event_legs event_legs_created_by_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_legs event_legs_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_legs event_legs_updated_by_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: events events_updated_by_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: events events_va_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict ctURAgXLFAZF4Qthc58RRWfe5CaB6ggdUYbnky2DQw6V8Wvwc3ZcHKEs50dqUep
