...
// VAEventService handles business logic for VA events
type VAEventService struct {
	eventRepo *repositories.VAEventRepository
}

// NewVAEventService creates a new VA event service
func NewVAEventService(eventRepo *repositories.VAEventRepository) *VAEventService {
	return &VAEventService{
		eventRepo: eventRepo,
	}
}
...
func (s *VAEventService) CreateEvent(ctx context.Context, vaID string, req CreateEventRequest) (*gorm.VAEvent, error) {
	// Validate
...
func (s *VAEventService) UpdateEvent(ctx context.Context, eventID string, req UpdateEventRequest) (*gorm.VAEvent, error) {
	// Get existing event
...
func (s *VAEventService) DeleteEvent(ctx context.Context, eventID string) error {
	// Verify event exists
...
func (s *VAEventService) GetEvent(ctx context.Context, eventID string) (*gorm.VAEvent, error) {
	event, err := s.eventRepo.GetByID(ctx, eventID)
	if err != nil {
		return nil, fmt.Errorf("event not found: %w", err)
	}
...
func (s *VAEventService) ListEvents(ctx context.Context, vaID string) ([]gorm.VAEvent, error) {
...
func (s *VAEventService) GetActiveEvents(ctx context.Context, vaID string) ([]gorm.VAEvent, error) {
...
func (s *VAEventService) GetEventForRoute(ctx context.Context, vaID, route string) (*gorm.VAEvent, error) {
...
func (s *VAEventService) validateCreateRequest(req CreateEventRequest) error {
...
func (s *VAEventService) validateEvent(event *gorm.VAEvent) error {
...
func (s *VAEventService) ToResponse(event *gorm.VAEvent) EventResponse {
