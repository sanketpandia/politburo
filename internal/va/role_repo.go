...
// RoleRepository manages VA user role data with GORM
type RoleRepository struct {
	db *gorm.DB
}

// NewRoleRepository creates a new VA user role repository
func NewRoleRepository(db *gorm.DB) *RoleRepository {
	return &RoleRepository{db: db}
}

// GetByID retrieves a user's VA role by ID
func (r *RoleRepository) GetByID(ctx context.Context, id string) (*models.UserVARole, error) {
...
func (r *RoleRepository) GetByUserAndVA(ctx context.Context, userID, vaID string) (*models.UserVARole, error) {
	var role models.UserVARole
...
func (r *RoleRepository) GetAllByUserID(ctx context.Context, userID string) ([]models.UserVARole, error) {
...
func (r *RoleRepository) GetAllByVAID(ctx context.Context, vaID string) ([]models.UserVARole, error) {
	var roles []models.UserVARole
...
func (r *RoleRepository) Create(ctx context.Context, role *models.UserVARole) error {
...
func (r *RoleRepository) Update(ctx context.Context, role *models.UserVARole) error {
...
func (r *RoleRepository) GetByDiscordIDs(ctx context.Context, discordUserID, discordServerID string) (*models.UserVARole, error) {
	var role models.UserVARole
...
func (r *RoleRepository) GetByCallsignAndVAID(ctx context.Context, callsign, vaID, excludeID string) (*models.UserVARole, error) {
	var role models.UserVARole
